...
*/
 ...
 class MT_Controller extends CI_Controller
 {
 	...
 	function __construct()
 	{
		...
		$this->load->model(array('menumodel','tenantmodel'));
	...
	{
		 $tenant_info = $this->tenantmodel->get_tenant_info($this->subdomain);
		 return $tenant_info;
	} 
	...
	function upload_dir()
	{
		return './public/assets/upload_images/';
	}
	...
	function validation_error_msg()
	{
		return $this->form_validation->set_error_delimiters('<span class="verr"><i class="fa fa-exclamation-circle"></i> ', '</span>');
	}
