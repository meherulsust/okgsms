...
class Menu extends MT_Controller
{
    ...
    {
        $head = array('page_title'=>'Menu List','link_title'=>'New Menu','link_action'=>'menu/add');
        ...
        $this->load->view('menu/menu_list', $head);
    }
    /**
    ...
    public function add($parent_id = '')
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $head = array('page_title'=>'New Menu','link_title'=>'Menu List','link_action'=>'menu/index');
            $this->load->view('menu/new_menu',$head);
        }
    }
    ...
    public function edit($id = '', $parent_id = '')
    {
        ...
        if (!empty($row)) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                $this->assign('status_option', $status_option);
                $this->assign('parent_id', $parent_id);
                $head = array('page_title'=>'Edit Menu','link_title'=>'Nemu List','link_action'=>'menu/index');
                $this->load->view('menu/edit_menu',$head);
            }
        } else {
            $this->view_404();
        }
    ...
    public function view($id = '')
    {
        ...
        //------------ for grid board ---------------//
        $head = array('page_title'=>'Menu Details','link_title'=>'Menu List','link_action'=>'menu/index');
        $labels = array('menu_title' => 'Title', 'module_link' => 'Module Link', 'order' => 'Order', 'status' => 'Status');
        $this->tpl->set_js(array('jquery.statusmenu'));
        $this->assign('labels', $labels);
