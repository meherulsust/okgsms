...
class Admingroup extends MT_Controller
{
    ...
    public function index($sort_type = 'desc', $sort_on = 'id')
    {
        ...
        $head = array('page_title'=>'Admin Group List','link_title'=>'New group','link_action'=>'admingroup/add');
        ...
        $this->load->view('admingroup/list',$head);
    }

    public function add()
    {
        $head = array('page_title'=>'New Admin Group','link_title'=>'Group List','link_action'=>'admingroup/index');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('admingroup/new',$head);
        } else {
    ...
    public function edit($id = '')
    {
        ...
        if (!empty($row)) {
            ...
            if ($this->form_validation->run() == false) {
                $status_option = array('Active' => 'Active', 'Inactive' => 'Inactive');
                $this->assign('status_option', $status_option);
                $head = array('page_title'=>'Edit Admin Group','link_title'=>'Group List','link_action'=>'admingroup/index');
                $this->load->view('admingroup/edit',$head);
            } else {
