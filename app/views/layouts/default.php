...
<head>
  ...
  <link href="<?php echo $css_url; ?>chosen.css" rel="stylesheet" type="text/css" />
  ...
  <script src="<?php echo $js_url; ?>app/app.js" type="text/javascript"></script>
  <script src="<?php echo $js_url; ?>chosen.js" type="text/javascript"></script>
...
<body class="skin-blue fixed">
  <header class="header">
    <a href="<?php echo $base_url; ?>" class="logo">
        <img src="<?= isset($tenant_info['logo']) ? $upload_url.'logo/'.$tenant_info['logo'] : $upload_url.'logo/logo.png'; ?>"  alt="<?= isset($tenant_info['title']) ? $tenant_info['title'] :'OKGS';?>" height="60" /> 
    </a>
  ...
  <div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
      ...
      <div id="copy-right">
        <p>All rights preserved by <a href='www.aimictacademy.com'>AIM ICT ACADEMY</a> <?php echo date('Y') - 1 . '-' . date('Y') ?></p>
      </div>
    </aside>
  </div>
</body>
