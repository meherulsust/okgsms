	...
	<form class="ajax_submit" role="form" action="<?=$site_url.$active_controller?>/add" method="post" enctype="multipart/form-data">
		<table class="form_table">
			...
			<tr>
				<td>Class Code :</td>
				<td>
					<input name="code" class="form-control" type="text" value="<?=set_value('code'); ?>"/>
			...
			<tr>
				...
				<td>
					<input type="text" class="form-control calander"  name="start_date" value="<?=set_value('start_date'); ?>" required />
			...
			<tr>
				...
				<td>
					<input type="text" class="form-control calander"  name="end_date" value="<?=set_value('end_date'); ?>" required/>
					<span class="add-on"><span class="glyphicon glyphicon-calendar"></span>
			...
			<tr>
				...
				<td>
					<select class="form-control" name="result_scale_id" required>
						...
						<?php echo html_options($scale_options,set_value('result_scale_id')) ;?>
					</select> 
			...
			<tr>
				...
				<td>
					<select class="form-control" name="is_result_publish" required>
						...
						<?php echo html_options($result_options,set_value('is_result_publish')) ;?>
					</select> 
