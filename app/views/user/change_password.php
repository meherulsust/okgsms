<div id="box">
  ...
  <form id="form" action="<?=$site_url . $active_controller?>/index/<?=$id;?>" method="post">
    <fieldset id="personal">
      ...
      <input name="old_password" type="hidden" value="<?=$password;?>" />
      <input name="old_password" id="old_password" class='text' type="password" tabindex="1" /><span
        class='req'>*</span> <?php echo form_error('old_password'); ?>
      <br />
      <label for="password">New Password : </label>
      <input name="new_password" id="password" class='text' type="password" tabindex="2" /><span class='req'>*</span>
