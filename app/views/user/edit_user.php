  ...
  <form role="form" action="<?php echo $site_url . $active_controller ?>/edit/<?php echo encode($id); ?>" method="post"
    ...
    <table class="form_table">
      <tr>
        ...
        <td>
          <input name="username" type="text" class="form-control" value="<?=set_value('username', $username);?>"
            required autocomplete="new-username" <?= $readonly; ?>/>
      ...
      <tr>
        <td>Full Name :</td>
        <td>
          <input name="full_name" type="text" class="form-control" value="<?=set_value('full_name', $full_name);?>"
            required />
      ...
      <tr id ='tenant'>
        ...
        <td>
          <select class="form-control" name="tenant_id">
            ...
            <?php echo html_options($tenant_options, set_value('tenant_id',$tenant_id)); ?>
          </select>
