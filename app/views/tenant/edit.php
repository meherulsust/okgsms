  ...
  <form role="form" action="<?php echo $site_url . $active_controller ?>/edit/<?php echo encode($id); ?>" method="post"
    ...
    <tr>
      ...
      <tr>
        <td>Subdomain :</td>
        <td>
          <input name="subdomain" type="text" class="form-control" value="<?=set_value('subdomain',$subdomain);?>" required />
          <span class='error'>* <?php echo form_error('subdomain'); ?></span>
        </td>
      </tr>
      <tr>
        <td>Email :</td>
      ...
      <tr>
        ...
        <td>
          <input name="contact_number" type="text" class="form-control" value="<?=set_value('contact_number',$contact_number);?>" required />
      ...
      <tr>
          ...
          <td>
            <select class="form-control" name="country_id">
              ...
              <?php echo html_options($country_options, set_value('country_id',$country_id)); ?>
            </select>
