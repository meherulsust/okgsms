  ...
  <form class="ajax_submit" role="form" action="<?=$site_url . $active_controller?>/add" method="post"
    ...
    <table class="form_table">
      ...
      <tr>
        <td>Subdomain :</td>
        <td>
          <input name="subdomain" type="text" class="form-control" value="<?=set_value('subdomain');?>" required />
      ...
      <tr>
        ...
        <td>
          <input name="contact_number" type="text" class="form-control" value="<?=set_value('contact_number');?>" required />
