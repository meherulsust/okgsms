...
class Template
{
    ...
    public function __construct()
    {
        ...
        $this->css_url = $this->base_url . 'public/assets/css/';
        $this->js_url = $this->base_url. 'public/assets/js/';
        $this->image_url = $this->base_url. 'public/assets/img/';
        $this->upload_url =  $this->base_url.'public/assets/upload_images/';
